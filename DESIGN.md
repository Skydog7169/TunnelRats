...
- **Shoring timbers:** carried item, finite (config), placed as a tile against tunnel walls/ceiling; resupply only at own trench. Placement makes noise (matters in Phase 3).
